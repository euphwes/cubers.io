(function() {
    ...
    // Stuff related to custom Square-1 colors
    ...
    // Stuff related to custom Square-1 colors
    Settings.USE_CUSTOM_REX_COLORS = 'use_custom_rex_colors';
    Settings.CUSTOM_REX_COLOR_U    = 'custom_rex_color_U';
    Settings.CUSTOM_REX_COLOR_F    = 'custom_rex_color_F';
    Settings.CUSTOM_REX_COLOR_R    = 'custom_rex_color_R';
    Settings.CUSTOM_REX_COLOR_D    = 'custom_rex_color_D';
    Settings.CUSTOM_REX_COLOR_B    = 'custom_rex_color_B';
    Settings.CUSTOM_REX_COLOR_L    = 'custom_rex_color_L';
