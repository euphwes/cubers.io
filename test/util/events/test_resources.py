...
def test_333_relay_of_3(mocker: MockerFixture):
    ...
    mocked_scrambler333 = mocker.patch('app.util.events.resources.scrambler333')
...
def test_234_relay_of_3(mocker: MockerFixture):
    ...
    mocked_scrambler222 = mocker.patch('app.util.events.resources.scrambler222')
    mocked_scrambler222.get_WCA_scramble.return_value = _222_SCRAMBLE

    mocked_scrambler333 = mocker.patch('app.util.events.resources.scrambler333')
    mocked_scrambler333.get_WCA_scramble.return_value = _333_SCRAMBLE

    mocked_scrambler444 = mocker.patch('app.util.events.resources.scrambler444')
