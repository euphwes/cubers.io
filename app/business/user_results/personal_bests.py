""" Stuff related to user PBs (personal bests). """
...
def set_pb_flags(user, event_result, event_id, event_format):
    """ Sets the appropriate flag if either the single or average for this event is a PB. """

    pb_single, pb_average = __get_pbs_for_user_and_event_excluding_latest(user.id, event_id)
