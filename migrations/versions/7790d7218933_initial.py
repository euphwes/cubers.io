...
Revision ID: 7790d7218933
Revises: 
Create Date: 2018-05-31 20:11:59.007634
...
def upgrade():
    ...
    op.create_index(op.f('ix_competitions_reddit_thread_id'), 'competitions', ['reddit_thread_id'], unique=True)
    ...
    sa.Column('eventFormat', sa.Enum('Ao5', 'Mo3', 'Bo3', name='eventFormat'), nullable=True),
    ...
    op.bulk_insert(
        ...
        [
            ...
            {'totalSolves': 5, 'eventFormat': EventFormat.Ao5, 'name': '2-3-4 Relay'           },
            {'totalSolves': 5, 'eventFormat': EventFormat.Ao5, 'name': 'FMC'                   },
            {'totalSolves': 5, 'eventFormat': EventFormat.Ao5, 'name': '3x3 With Feet'         },
            {'totalSolves': 5, 'eventFormat': EventFormat.Ao5, 'name': '3x3 Relay of 3'        },
            {'totalSolves': 5, 'eventFormat': EventFormat.Ao5, 'name': 'PLL Time Attack'       },
        ]
    )
...
def downgrade():
    ...
    op.drop_index(op.f('ix_competitions_reddit_thread_id'), table_name='competitions')
